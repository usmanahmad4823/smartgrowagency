...
export function AddOns() {
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
      {addOns.map((addon) => (
        <div key={addon.name} className="flex items-center justify-between p-5 rounded-[16px] border border-[var(--border-subtle)] bg-[var(--glass-bg)] hover:bg-[var(--bg-secondary)] transition-colors">
